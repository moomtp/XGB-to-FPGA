...
class Gen_leaf_node(Gen_strategy):
...
class Gen_fix16_leaf_node(Gen_strategy):
    # node val + accumulate of  nodes num & cur node num + node flag + class func
    def gen(self, _node):
        from node import Node
        last_tree_flag = "1" if _node.is_last_tree else "0"
...
class Gen_tree_node_float16(Gen_strategy):
...
class Gen_tree_node_fix_float16(Gen_strategy):
    # feature idx + node val + @rel addr to right(val from tree) + class func
    def gen(self, _node):
        from node import Node
        # return i_to_b(_node.get_feature_idx(), 8) + i_to_b(_node.jump_addr, 7) + "1"
...
class Gen_tree_node_int16(Gen_strategy):
    pass

# special node's gen strategy
class Gen_non_func_leaf_node(Gen_strategy):
    def gen(self, _node):
        return "00000000000000000000000000000011"
class Gen_thread_node(Gen_strategy):
    def gen(self, _node):
        return "00000000000000000000000000000111"
        # return "00000007"
class Gen_class_end_node(Gen_strategy):
    def gen(self, _node):
        return "00000000000000000000000000001111"
        # return "0000000f"
class Gen_classes_end_node(Gen_strategy):
    def gen(self, _node):
