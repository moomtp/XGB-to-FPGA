...
from gen_behavior import Gen_strategy
...
class XGB_tree_manager:
    ...
    def __init__(self, filepath:str):
        ...
        self.num_classes = int(data["learner"]["gradient_booster"]['model']['trees'][0]['tree_param']['num_feature'])  
    ...
    def set_tree_node_gen_behavior(self, _gen_behavior:Gen_strategy):
        for class_trees in self.classes_tree:
            for tree in class_trees:
                tree.set_tree_node_gen_behavior(_gen_behavior)
                
    def set_leaf_node_gen_behavior(self, _gen_behavior:Gen_strategy):
        for class_trees in self.classes_tree:
            for tree in class_trees:
