...
from gen_behavior import Gen_strategy, Gen_leaf_node, Gen_tree_node_float16
...
class Node():
    ...
    gen_behaivor:Gen_strategy=Gen_strategy()
...
class LeafNode(Node):
    ...
    # is_last_tree:bool
    gen_behaivor:Gen_strategy = Gen_leaf_node
...
class TreeNode(Node):
    ...
    gen_behaivor:Gen_strategy = Gen_tree_node_float16
    feature_idx:int = -1
